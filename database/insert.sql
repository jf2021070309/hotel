...
INSERT INTO `anticipos` (`id`, `stay_id`, `monto`, `moneda`, `monto_pen`, `tc_aplicado`, `tipo_pago`, `recibo`, `fecha`, `aplicado`, `observacion`, `usuario_id`, `created_at`) VALUES
...
INSERT INTO `auditoria` (`id`, `usuario_id`, `accion`, `modulo`, `detalle`, `fecha_hora`, `ip`) VALUES
...
INSERT INTO `caja_chica` (`id`, `nombre`, `saldo_inicial`, `saldo_final`, `fecha_apertura`, `fecha_cierre`, `estado`, `usuario_apertura`, `usuario_cierre`, `created_at`) VALUES
...
INSERT INTO `caja_chica_movimientos` (`id`, `caja_id`, `tipo`, `monto`, `categoria_id`, `rubro`, `documento`, `fecha`, `observacion`, `usuario_id`, `anulado`, `motivo_anulacion`, `created_at`) VALUES
...
INSERT INTO `clientes` (`id`, `tipo_cliente`, `documento_tipo`, `documento_num`, `ruc`, `empresa`, `nombre_razon_social`, `celular`, `email`, `nacionalidad`, `pais_origen`, `ciudad`, `created_at`) VALUES
...
INSERT INTO `desayunos` (`id`, `fecha`, `pax_calculado`, `pax_ajustado`, `observacion`, `usuario_id`, `created_at`) VALUES
...
INSERT INTO `desayunos_detalle` (`id`, `desayuno_id`, `stay_id`, `pax`, `incluye_desayuno`) VALUES
	(1, 1, 1, 1, 1),
	(4, 2, 1, 1, 1),
	(5, 2, 2, 1, 1);

-- Volcando datos para la tabla hotel_db.finanzas_categorias: ~28 rows (aproximadamente)
INSERT INTO `finanzas_categorias` (`id`, `modulo`, `tipo`, `nombre`, `orden`, `activo`) VALUES
...
INSERT INTO `flujo_caja` (`id`, `fecha`, `turno`, `estado`, `nota_entrega`, `usuario_id`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `flujo_caja_movimientos` (`id`, `flujo_id`, `categoria_id`, `stay_id`, `tipo`, `monto`, `moneda`, `medio_pago`, `documento`, `observacion`, `vuelto`, `created_at`) VALUES
...
INSERT INTO `gastos_yape` (`id`, `fecha`, `turno`, `yape_recibido`, `total_gastado`, `vuelto`, `observacion`, `estado`, `usuario_id`, `created_at`) VALUES
...
INSERT INTO `gastos_yape_detalle` (`id`, `gasto_yape_id`, `categoria_id`, `rubro`, `monto`, `observacion`, `documento`, `created_at`) VALUES
...
INSERT INTO `habitaciones` (`id`, `numero`, `tipo`, `piso`, `estado`, `precio_base`, `descripcion`, `activa`) VALUES
...
INSERT INTO `inventario_movimientos` (`id`, `producto_id`, `tipo`, `cantidad`, `stock_antes`, `stock_despues`, `stay_id`, `usuario_id`, `created_at`) VALUES
...
INSERT INTO `inventario_productos` (`id`, `nombre`, `categoria`, `refrigeradora`, `precio_venta`, `stock_actual`, `activo`) VALUES
...
INSERT INTO `limpieza_registros` (`id`, `fecha`, `habitacion_id`, `tipo_limpieza`, `prioridad`, `estado`, `hora_inicio`, `hora_fin`, `observacion`, `usuario_id`, `created_at`) VALUES
...
INSERT INTO `rooming_pax` (`id`, `stay_id`, `cliente_id`, `es_titular_acompanante`, `created_at`, `vip`) VALUES
...
INSERT INTO `rooming_stays_historial_fechas` (`id`, `stay_id`, `fecha_checkout_pasada`, `motivo`, `usuario_id`, `created_at`) VALUES
...
INSERT INTO `tipos_cambio` (`id`, `moneda_origen`, `moneda_destino`, `factor`, `fecha`, `created_at`) VALUES
...
INSERT INTO `usuarios` (`id`, `usuario`, `password`, `rol`, `nombre`, `estado`, `created_at`) VALUES
