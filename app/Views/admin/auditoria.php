    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <div>
        <h4 class="fw-bold" style="color: #111; letter-spacing: -0.5px;">
          <i class="bi bi-journal-text me-2" style="color: #d4af37;"></i>Auditoría del Sistema
        </h4>
        <p class="mb-0 small text-muted fw-semibold">Registro histórico de acciones y eventos — <?= date('d/m/Y') ?></p>
      </div>
    </div>
  </div>
